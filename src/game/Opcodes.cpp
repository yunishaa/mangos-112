...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x349 / { "SMSG_ARENA_TEAM_COMMAND_RESULT",   STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::Handle_ServerSide               },
    /*0x34A / { "UMSG_UPDATE_ARENA_TEAM_OBSOLETE",  STATUS_NEVER,    &WorldSession::Handle_NULL                     },
    /*0x34B / { "CMSG_ARENA_TEAM_QUERY",            STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamQueryOpcode      },
    /*0x34C / { "SMSG_ARENA_TEAM_QUERY_RESPONSE",   STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::Handle_ServerSide               },
    /*0x34D / { "CMSG_ARENA_TEAM_ROSTER",           STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamRosterOpcode     },
    /*0x34E / { "SMSG_ARENA_TEAM_ROSTER",           STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::Handle_ServerSide               },
    /*0x34F / { "CMSG_ARENA_TEAM_INVITE",           STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamAddMemberOpcode  },
    /*0x350 / { "SMSG_ARENA_TEAM_INVITE",           STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::Handle_ServerSide               },
    /*0x351 / { "CMSG_ARENA_TEAM_ACCEPT",           STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamInviteAcceptOpcode},
    /*0x352 / { "CMSG_ARENA_TEAM_DECLINE",          STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamInviteDeclineOpcode},
    /*0x353 / { "CMSG_ARENA_TEAM_LEAVE",            STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamLeaveOpcode      },
    /*0x354 / { "CMSG_ARENA_TEAM_REMOVE",           STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamRemoveFromTeamOpcode},
    /*0x355 / { "CMSG_ARENA_TEAM_DISBAND",          STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamDisbandOpcode    },
    /*0x356 / { "CMSG_ARENA_TEAM_LEADER",           STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleArenaTeamPromoteToCaptainOpcode},
    /*0x357 / { "SMSG_ARENA_TEAM_EVENT",            STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::Handle_ServerSide               },
    /*0x358 / { "CMSG_BATTLEMASTER_JOIN_ARENA",     STATUS_NEVER,	 &WorldSession::Handle_NULL                     },//&WorldSession::HandleBattleGroundArenaJoin     },
    ...
    /*0x377 / { "MSG_INSPECT_ARENA_TEAMS",          STATUS_NEVER,    &WorldSession::Handle_NULL                     },//&WorldSession::HandleInspectArenaStatsOpcode   },
