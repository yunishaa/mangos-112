...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        uint32 GetQuestSlotTime(uint16 slot)    const { return 0; /*GetUInt32Value(PLAYER_QUEST_LOG_1_1 + slot*MAX_QUEST_OFFSET + QUEST_TIME_OFFSET);*/ }
